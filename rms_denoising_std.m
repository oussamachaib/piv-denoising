...
%% RMSE variances
figure()
plot(ss,RMSEn,'.','MarkerSize',20)
hold on;
plot(ss,RMSEd,'.','MarkerSize',20)
hold on;
plot(ss,RMSEd1,'.','MarkerSize',20)
hold on;
plot(ss,RMSEd2,'.','MarkerSize',20)
hold on;
plot(ss,RMSEd3,'.','MarkerSize',20)
hold off;
...
%saveas(gcf,'figures/denoising/sigma_new2.jpg')

%saveas(gcf,'figures/denoising/sigma_parab_weng_median.jpg')
