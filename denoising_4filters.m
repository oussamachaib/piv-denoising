...
stdev = .15; % as a fraction of the maximum intensity
var = stdev^2;
...
hold on;
title('Wavelet','Interpreter','latex');
set(h,'LineColor','none')
colormap(parula);
colorbar();
xlim([0,512])
...
% saveas(gcf,'figures/denoising/vfield_'+string(imname)+'_'+'sigma'+string(stdev)+'.jpg')
